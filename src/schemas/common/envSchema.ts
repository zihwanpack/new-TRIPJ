...
export const envSchema = z.object({
  ...
  VITE_LOCAL_GOOGLE_CALLBACK_URL: z.url('Local Google Callback URL이 올바르지 않습니다.'),
  VITE_LOCAL_KAKAO_CALLBACK_URL: z.url('Local Kakao Callback URL이 올바르지 않습니다.'),
  VITE_LOCAL_NAVER_CALLBACK_URL: z.url('Local Naver Callback URL이 올바르지 않습니다.'),
